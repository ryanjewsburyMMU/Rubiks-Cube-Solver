...
class QDomDocument(PySide6.QtXml.QDomNode):
    ...
    @typing.overload
    def setContent(self, text: PySide6.QtCore.QByteArray) -> typing.Tuple[bool, str, int, int]: ...
    @typing.overload
    def setContent(self, text: PySide6.QtCore.QByteArray, namespaceProcessing: bool) -> typing.Tuple[bool, str, int, int]: ...
    @typing.overload
