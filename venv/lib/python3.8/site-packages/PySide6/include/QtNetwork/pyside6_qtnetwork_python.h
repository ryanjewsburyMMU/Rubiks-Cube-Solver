...
enum : int {
    ...
    SBK_QHOSTADDRESS_SPECIALADDRESS_IDX                      = 28,
    SBK_QHOSTADDRESS_CONVERSIONMODEFLAG_IDX                  = 27,
    SBK_QFLAGS_QHOSTADDRESS_CONVERSIONMODEFLAG_IDX           = 20,
    SBK_QHOSTADDRESS_IDX                                     = 26,
    SBK_QHOSTINFO_HOSTINFOERROR_IDX                          = 30,
    SBK_QHOSTINFO_IDX                                        = 29,
    SBK_QHSTSPOLICY_POLICYFLAG_IDX                           = 32,
    SBK_QFLAGS_QHSTSPOLICY_POLICYFLAG_IDX                    = 21,
    SBK_QHSTSPOLICY_IDX                                      = 31,
    SBK_QHTTPMULTIPART_CONTENTTYPE_IDX                       = 34,
    SBK_QHTTPMULTIPART_IDX                                   = 33,
    SBK_QHTTPPART_IDX                                        = 35,
    SBK_QIPV6ADDRESS_IDX                                     = 36,
    SBK_QLOCALSERVER_SOCKETOPTION_IDX                        = 38,
    SBK_QFLAGS_QLOCALSERVER_SOCKETOPTION_IDX                 = 22,
    SBK_QLOCALSERVER_IDX                                     = 37,
    SBK_QLOCALSOCKET_LOCALSOCKETERROR_IDX                    = 40,
    SBK_QLOCALSOCKET_LOCALSOCKETSTATE_IDX                    = 41,
    SBK_QLOCALSOCKET_IDX                                     = 39,
    SBK_QNETWORKACCESSMANAGER_OPERATION_IDX                  = 43,
    SBK_QNETWORKACCESSMANAGER_IDX                            = 42,
    SBK_QNETWORKADDRESSENTRY_DNSELIGIBILITYSTATUS_IDX        = 45,
    SBK_QNETWORKADDRESSENTRY_IDX                             = 44,
    SBK_QNETWORKCACHEMETADATA_IDX                            = 46,
    SBK_QNETWORKCOOKIE_RAWFORM_IDX                           = 48,
    SBK_QNETWORKCOOKIE_IDX                                   = 47,
    SBK_QNETWORKCOOKIEJAR_IDX                                = 49,
    SBK_QNETWORKDATAGRAM_IDX                                 = 50,
    SBK_QNETWORKDISKCACHE_IDX                                = 51,
    SBK_QNETWORKINTERFACE_INTERFACEFLAG_IDX                  = 53,
    SBK_QFLAGS_QNETWORKINTERFACE_INTERFACEFLAG_IDX           = 23,
    SBK_QNETWORKINTERFACE_INTERFACETYPE_IDX                  = 54,
    SBK_QNETWORKINTERFACE_IDX                                = 52,
    SBK_QNETWORKPROXY_PROXYTYPE_IDX                          = 57,
    SBK_QNETWORKPROXY_CAPABILITY_IDX                         = 56,
    SBK_QFLAGS_QNETWORKPROXY_CAPABILITY_IDX                  = 24,
    SBK_QNETWORKPROXY_IDX                                    = 55,
    SBK_QNETWORKPROXYFACTORY_IDX                             = 58,
    SBK_QNETWORKPROXYQUERY_QUERYTYPE_IDX                     = 60,
    SBK_QNETWORKPROXYQUERY_IDX                               = 59,
    SBK_QNETWORKREPLY_NETWORKERROR_IDX                       = 62,
    SBK_QNETWORKREPLY_IDX                                    = 61,
    SBK_QNETWORKREQUEST_KNOWNHEADERS_IDX                     = 66,
    SBK_QNETWORKREQUEST_ATTRIBUTE_IDX                        = 64,
    SBK_QNETWORKREQUEST_CACHELOADCONTROL_IDX                 = 65,
    SBK_QNETWORKREQUEST_LOADCONTROL_IDX                      = 67,
    SBK_QNETWORKREQUEST_PRIORITY_IDX                         = 68,
    SBK_QNETWORKREQUEST_REDIRECTPOLICY_IDX                   = 69,
    SBK_QNETWORKREQUEST_TRANSFERTIMEOUTCONSTANT_IDX          = 70,
    SBK_QNETWORKREQUEST_IDX                                  = 63,
    SBK_QOCSPRESPONSE_IDX                                    = 72,
    SBK_QtNetworkQPASSWORDDIGESTOR_IDX                       = 74,
    SBK_QSSL_KEYTYPE_IDX                                     = 81,
    SBK_QSSL_ENCODINGFORMAT_IDX                              = 79,
    SBK_QSSL_KEYALGORITHM_IDX                                = 80,
    SBK_QSSL_ALTERNATIVENAMEENTRYTYPE_IDX                    = 78,
    SBK_QSSL_SSLPROTOCOL_IDX                                 = 83,
    SBK_QSSL_SSLOPTION_IDX                                   = 82,
    SBK_QFLAGS_QSSL_SSLOPTION_IDX                            = 25,
    SBK_QSSL_ALERTLEVEL_IDX                                  = 76,
    SBK_QSSL_ALERTTYPE_IDX                                   = 77,
    SBK_QtNetworkQSSL_IDX                                    = 75,
    SBK_QSSLCERTIFICATE_SUBJECTINFO_IDX                      = 86,
    SBK_QSSLCERTIFICATE_PATTERNSYNTAX_IDX                    = 85,
    SBK_QSSLCERTIFICATE_IDX                                  = 84,
    SBK_QSSLCERTIFICATEEXTENSION_IDX                         = 87,
    SBK_QSSLCIPHER_IDX                                       = 88,
    SBK_QSSLCONFIGURATION_NEXTPROTOCOLNEGOTIATIONSTATUS_IDX  = 90,
    SBK_QSSLCONFIGURATION_IDX                                = 89,
    SBK_QSSLDIFFIEHELLMANPARAMETERS_ERROR_IDX                = 92,
    SBK_QSSLDIFFIEHELLMANPARAMETERS_IDX                      = 91,
    SBK_QSSLERROR_SSLERROR_IDX                               = 94,
    SBK_QSSLERROR_IDX                                        = 93,
    SBK_QSSLKEY_IDX                                          = 95,
    SBK_QSSLPRESHAREDKEYAUTHENTICATOR_IDX                    = 96,
    SBK_QSSLSOCKET_SSLMODE_IDX                               = 99,
    SBK_QSSLSOCKET_PEERVERIFYMODE_IDX                        = 98,
    SBK_QSSLSOCKET_IDX                                       = 97,
    SBK_QTCPSERVER_IDX                                       = 100,
    SBK_QTCPSOCKET_IDX                                       = 101,
    SBK_QUDPSOCKET_IDX                                       = 102,
    SBK_QOCSPCERTIFICATESTATUS_IDX                           = 71,
    SBK_QOCSPREVOCATIONREASON_IDX                            = 73,
    SBK_QtNetwork_IDX_COUNT                                  = 103
};
...
enum : int {
    ...
    SBK_QTNETWORK_QHASH_QSTRING_QVARIANT_IDX                 = 10, // QHash<QString,QVariant >
    SBK_QTNETWORK_QLIST_QOBJECTPTR_IDX                       = 11, // const QList<QObject* > &
    SBK_QTNETWORK_QLIST_QNETWORKCOOKIE_IDX                   = 12, // QList<QNetworkCookie >
    SBK_QTNETWORK_QLIST_QHSTSPOLICY_IDX                      = 13, // const QList<QHstsPolicy > &
    SBK_QTNETWORK_QLIST_QSSLERROR_IDX                        = 14, // const QList<QSslError > &
    SBK_QTNETWORK_QLIST_QDNSDOMAINNAMERECORD_IDX             = 15, // QList<QDnsDomainNameRecord >
    SBK_QTNETWORK_QLIST_QDNSHOSTADDRESSRECORD_IDX            = 16, // QList<QDnsHostAddressRecord >
    SBK_QTNETWORK_QLIST_QDNSMAILEXCHANGERECORD_IDX           = 17, // QList<QDnsMailExchangeRecord >
    SBK_QTNETWORK_QLIST_QDNSSERVICERECORD_IDX                = 18, // QList<QDnsServiceRecord >
    SBK_QTNETWORK_QLIST_QDNSTEXTRECORD_IDX                   = 19, // QList<QDnsTextRecord >
    SBK_QTNETWORK_QLIST_QOCSPRESPONSE_IDX                    = 20, // QList<QOcspResponse >
    ...
    SBK_QTNETWORK_QLIST_QVARIANT_IDX                         = 23, // QList<QVariant >
    SBK_QTNETWORK_QLIST_QSTRING_IDX                          = 24, // QList<QString >
    SBK_QTNETWORK_QMAP_QSTRING_QVARIANT_IDX                  = 25, // QMap<QString,QVariant >
    SBK_QtNetwork_CONVERTERS_IDX_COUNT                       = 26
};
