...
class QImage(PySide6.QtGui.QPaintDevice):
    ...
    @typing.overload
    def convertToFormat(self, f: PySide6.QtGui.QImage.Format, colorTable: typing.Sequence[int], flags: PySide6.QtCore.Qt.ImageConversionFlags = ...) -> PySide6.QtGui.QImage: ...
    @typing.overload
...
class QImageReader(Shiboken.Object):
    ...
    @staticmethod
    def imageFormatsForMimeType(mimeType: PySide6.QtCore.QByteArray) -> typing.List[PySide6.QtCore.QByteArray]: ...
    def jumpToImage(self, imageNumber: int) -> bool: ...
    def jumpToNextImage(self) -> bool: ...
    def loopCount(self) -> int: ...
    def nextImageDelay(self) -> int: ...
...
class QPointerEvent(PySide6.QtGui.QInputEvent):
    ...
    @typing.overload
    def __init__(self, type: PySide6.QtCore.QEvent.Type, dev: PySide6.QtGui.QPointingDevice, modifiers: PySide6.QtCore.Qt.KeyboardModifiers = ..., points: typing.Sequence[PySide6.QtGui.QEventPoint] = ...) -> None: ...
...
class QRawFont(Shiboken.Object):
    ...
    @typing.overload
    def advancesForGlyphIndexes(self, glyphIndexes: typing.Sequence[int], layoutFlags: PySide6.QtGui.QRawFont.LayoutFlags) -> typing.List[PySide6.QtCore.QPointF]: ...
...
class QStandardItemModel(PySide6.QtCore.QAbstractItemModel):
    ...
    def findItems(self, text: str, flags: PySide6.QtCore.Qt.MatchFlags = ..., column: int = ...) -> typing.List[PySide6.QtGui.QStandardItem]: ...
...
class QTextLayout(Shiboken.Object):
    ...
    def draw(self, p: PySide6.QtGui.QPainter, pos: PySide6.QtCore.QPointF, selections: typing.Sequence[PySide6.QtGui.QTextLayout.FormatRange] = ..., clip: PySide6.QtCore.QRectF = ...) -> None: ...
    @typing.overload
...
class QTouchEvent(PySide6.QtGui.QPointerEvent):
    ...
    @typing.overload
    def __init__(self, eventType: PySide6.QtCore.QEvent.Type, device: typing.Optional[PySide6.QtGui.QPointingDevice] = ..., modifiers: PySide6.QtCore.Qt.KeyboardModifiers = ..., touchPoints: typing.Sequence[PySide6.QtGui.QEventPoint] = ...) -> None: ...
