...
class QAbstractItemView(PySide6.QtWidgets.QAbstractScrollArea):
    ...
    def dataChanged(self, topLeft: PySide6.QtCore.QModelIndex, bottomRight: PySide6.QtCore.QModelIndex, roles: typing.Sequence[int] = ...) -> None: ...
...
class QAbstractScrollArea(PySide6.QtWidgets.QFrame):
    ...
    def scrollBarWidgets(self, alignment: PySide6.QtCore.Qt.Alignment) -> typing.List[PySide6.QtWidgets.QWidget]: ...
...
class QAccessibleWidget(PySide6.QtGui.QAccessibleObject):
    ...
    def relations(self, match: PySide6.QtGui.QAccessible.Relation = ...) -> typing.List[typing.Tuple[PySide6.QtGui.QAccessibleInterface, PySide6.QtGui.QAccessible.Relation]]: ...
...
class QCompleter(PySide6.QtCore.QObject):
    ...
    @typing.overload
    def __init__(self, completions: typing.Sequence[str], parent: typing.Optional[PySide6.QtCore.QObject] = ...) -> None: ...
    @typing.overload
...
class QFileDialog(PySide6.QtWidgets.QDialog):
    ...
    @staticmethod
    def getExistingDirectoryUrl(parent: typing.Optional[PySide6.QtWidgets.QWidget] = ..., caption: str = ..., dir: PySide6.QtCore.QUrl = ..., options: PySide6.QtWidgets.QFileDialog.Options = ..., supportedSchemes: typing.Sequence[str] = ...) -> PySide6.QtCore.QUrl: ...
    @staticmethod
    def getOpenFileName(parent: typing.Optional[PySide6.QtWidgets.QWidget] = ..., caption: str = ..., dir: str = ..., filter: str = ..., options: PySide6.QtWidgets.QFileDialog.Options = ...) -> typing.Tuple[str, str]: ...
    @staticmethod
    def getOpenFileNames(parent: typing.Optional[PySide6.QtWidgets.QWidget] = ..., caption: str = ..., dir: str = ..., filter: str = ..., options: PySide6.QtWidgets.QFileDialog.Options = ...) -> typing.Tuple[typing.List[str], str]: ...
    @staticmethod
    def getOpenFileUrl(parent: typing.Optional[PySide6.QtWidgets.QWidget] = ..., caption: str = ..., dir: PySide6.QtCore.QUrl = ..., filter: str = ..., options: PySide6.QtWidgets.QFileDialog.Options = ..., supportedSchemes: typing.Sequence[str] = ...) -> typing.Tuple[PySide6.QtCore.QUrl, str]: ...
    @staticmethod
    def getOpenFileUrls(parent: typing.Optional[PySide6.QtWidgets.QWidget] = ..., caption: str = ..., dir: PySide6.QtCore.QUrl = ..., filter: str = ..., options: PySide6.QtWidgets.QFileDialog.Options = ..., supportedSchemes: typing.Sequence[str] = ...) -> typing.Tuple[typing.List[PySide6.QtCore.QUrl], str]: ...
    @staticmethod
    def getSaveFileName(parent: typing.Optional[PySide6.QtWidgets.QWidget] = ..., caption: str = ..., dir: str = ..., filter: str = ..., options: PySide6.QtWidgets.QFileDialog.Options = ...) -> typing.Tuple[str, str]: ...
    @staticmethod
    def getSaveFileUrl(parent: typing.Optional[PySide6.QtWidgets.QWidget] = ..., caption: str = ..., dir: PySide6.QtCore.QUrl = ..., filter: str = ..., options: PySide6.QtWidgets.QFileDialog.Options = ..., supportedSchemes: typing.Sequence[str] = ...) -> typing.Tuple[PySide6.QtCore.QUrl, str]: ...
...
class QFileSystemModel(PySide6.QtCore.QAbstractItemModel):
    ...
    def mimeData(self, indexes: typing.List[int]) -> PySide6.QtCore.QMimeData: ...
...
class QFontDialog(PySide6.QtWidgets.QDialog):
    ...
    @typing.overload
    @staticmethod
    def getFont(initial: PySide6.QtGui.QFont, parent: typing.Optional[PySide6.QtWidgets.QWidget] = ..., title: str = ..., options: PySide6.QtWidgets.QFontDialog.FontDialogOptions = ...) -> typing.Tuple[PySide6.QtGui.QFont, bool]: ...
    @typing.overload
    @staticmethod
    def getFont(parent: typing.Optional[PySide6.QtWidgets.QWidget] = ...) -> typing.Tuple[PySide6.QtGui.QFont, bool]: ...
    @typing.overload
    def open(self) -> None: ...
    @typing.overload
    def open(self, receiver: PySide6.QtCore.QObject, member: bytes) -> None: ...
...
class QGraphicsScene(PySide6.QtCore.QObject):
    ...
    @typing.overload
    def items(self, polygon: PySide6.QtGui.QPolygonF, mode: PySide6.QtCore.Qt.ItemSelectionMode = ..., order: PySide6.QtCore.Qt.SortOrder = ..., deviceTransform: PySide6.QtGui.QTransform = ...) -> typing.List[PySide6.QtWidgets.QGraphicsItem]: ...
    @typing.overload
    def items(self, pos: PySide6.QtCore.QPointF, mode: PySide6.QtCore.Qt.ItemSelectionMode = ..., order: PySide6.QtCore.Qt.SortOrder = ..., deviceTransform: PySide6.QtGui.QTransform = ...) -> typing.List[PySide6.QtWidgets.QGraphicsItem]: ...
    @typing.overload
    def items(self, rect: PySide6.QtCore.QRectF, mode: PySide6.QtCore.Qt.ItemSelectionMode = ..., order: PySide6.QtCore.Qt.SortOrder = ..., deviceTransform: PySide6.QtGui.QTransform = ...) -> typing.List[PySide6.QtWidgets.QGraphicsItem]: ...
    @typing.overload
...
class QGraphicsView(PySide6.QtWidgets.QAbstractScrollArea):
    ...
    def drawBackground(self, painter: PySide6.QtGui.QPainter, rect: PySide6.QtCore.QRectF) -> None: ...
    def drawForeground(self, painter: PySide6.QtGui.QPainter, rect: PySide6.QtCore.QRectF) -> None: ...
    def drawItems(self, painter: PySide6.QtGui.QPainter, numItems: int, items: typing.Sequence[PySide6.QtWidgets.QGraphicsItem], options: typing.Sequence[PySide6.QtWidgets.QStyleOptionGraphicsItem]) -> None: ...
    def dropEvent(self, event: PySide6.QtGui.QDropEvent) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def items(self, polygon: PySide6.QtGui.QPolygon, mode: PySide6.QtCore.Qt.ItemSelectionMode = ...) -> typing.List[PySide6.QtWidgets.QGraphicsItem]: ...
    @typing.overload
...
class QInputDialog(PySide6.QtWidgets.QDialog):
    ...
    @staticmethod
    def getDouble(parent: PySide6.QtWidgets.QWidget, title: str, label: str, value: float, minValue: float = ..., maxValue: float = ..., decimals: int = ..., flags: PySide6.QtCore.Qt.WindowFlags = ..., step: float = ...) -> typing.Tuple[float, bool]: ...
    @staticmethod
    def getInt(parent: PySide6.QtWidgets.QWidget, title: str, label: str, value: int, minValue: int = ..., maxValue: int = ..., step: int = ..., flags: PySide6.QtCore.Qt.WindowFlags = ...) -> typing.Tuple[int, bool]: ...
    @staticmethod
    def getItem(parent: PySide6.QtWidgets.QWidget, title: str, label: str, items: typing.Sequence[str], current: int, editable: bool = ..., flags: PySide6.QtCore.Qt.WindowFlags = ..., inputMethodHints: PySide6.QtCore.Qt.InputMethodHints = ...) -> typing.Tuple[str, bool]: ...
    @staticmethod
    def getMultiLineText(parent: PySide6.QtWidgets.QWidget, title: str, label: str, text: str, flags: PySide6.QtCore.Qt.WindowFlags = ..., inputMethodHints: PySide6.QtCore.Qt.InputMethodHints = ...) -> typing.Tuple[str, bool]: ...
    @staticmethod
    def getText(parent: PySide6.QtWidgets.QWidget, title: str, label: str, echo: PySide6.QtWidgets.QLineEdit.EchoMode, text: str = ..., flags: PySide6.QtCore.Qt.WindowFlags = ..., inputMethodHints: PySide6.QtCore.Qt.InputMethodHints = ...) -> typing.Tuple[str, bool]: ...
...
class QListWidget(PySide6.QtWidgets.QListView):
    ...
    def event(self, e: PySide6.QtCore.QEvent) -> bool: ...
    def findItems(self, text: str, flags: PySide6.QtCore.Qt.MatchFlags) -> typing.List[PySide6.QtWidgets.QListWidgetItem]: ...
...
class QMenu(PySide6.QtWidgets.QWidget):
    ...
    @typing.overload
    @staticmethod
    def exec_(actions: typing.Sequence[PySide6.QtGui.QAction], pos: PySide6.QtCore.QPoint, at: typing.Optional[PySide6.QtGui.QAction] = ..., parent: typing.Optional[PySide6.QtWidgets.QWidget] = ...) -> PySide6.QtGui.QAction: ...
    @typing.overload
...
class QTableWidget(PySide6.QtWidgets.QTableView):
    ...
    def event(self, e: PySide6.QtCore.QEvent) -> bool: ...
    def findItems(self, text: str, flags: PySide6.QtCore.Qt.MatchFlags) -> typing.List[PySide6.QtWidgets.QTableWidgetItem]: ...
...
class QTreeWidget(PySide6.QtWidgets.QTreeView):
    ...
    def findItems(self, text: str, flags: PySide6.QtCore.Qt.MatchFlags, column: int = ...) -> typing.List[PySide6.QtWidgets.QTreeWidgetItem]: ...
...
class QWidget(PySide6.QtCore.QObject, PySide6.QtGui.QPaintDevice):
    ...
    def nativeEvent(self, eventType: PySide6.QtCore.QByteArray, message: int) -> typing.Tuple[bool, int]: ...
